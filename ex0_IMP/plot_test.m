...
y = y(2:end,:);
plot(t,y(:,2));
DAT1 = load('IMP_P1_dt0.001.dat');
DAT2 = load('IMP_P1_dt0.002.dat');
DAT3 = load('IMP_P1_dt0.004.dat');
DAT4 = load('IMP_P1_dt0.008.dat');
DAT5 = load('IMP_P1_dt0.016.dat');
DAT6 = load('IMP_P1_dt0.100.dat');
...
err(6) = norm(DAT6(:,2)-y(1:100:end,2), 2);
err
